var MyGame2 = Framework.Class(Framework.Level , {
	load: function(){
        ...
        ////////Load通道/////////
        this.gameTunnel[0]=new GameGTunnel(14); 
        this.gameTunnel[0].load(200,160,90);
        this.rootScene.attach(this.gameTunnel[0]);


        ////////移動型障礙/////////
        this.MBlock=new MovingHBlock();
        this.MBlock.load(200,600);
        this.rootScene.attach(this.MBlock.blockPic);

        ////////Load終點/////////
        this.goalpic = new GoalSign();
        this.goalpic.load(200,880);
    ...
    update: function() {
        ...
        if(this.MBlock.collide(this.mousepic)){
            this.isOut=true;
        }
