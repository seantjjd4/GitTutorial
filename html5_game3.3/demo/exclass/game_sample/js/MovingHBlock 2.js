var MovingHBlock=Framework.exClass(MovingBlock,{
/*	load:function(px,py){
...
*/
	update: function() {
		if(this.swing_position.x+180<this.blockPic.lowerRight.x){
			this.speed=-1;
		}
		else if(this.swing_position.x-180>this.blockPic.upperLeft.x){
			this.speed=1;
		}
