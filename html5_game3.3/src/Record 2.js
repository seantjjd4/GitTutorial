var Framework = (function (Framework) {
    ...
    Framework.Record = function() {
        ...
        this.resetWaitCounter = function () {  // 2017.11, ¤£¤Ówork
			this.waitCounter = 0;
		}
        this.getWaitCounter = function () {  // 2017.12
        ...
        this.click = function (e) {
            this.recordWait();
            this.record.push("Framework.Replay.mouseClick("+e.x+","+e.y+");");  // 2017.04.18 marked
            this.addDivString('&nbsp;&nbsp;&nbsp;&nbsp;'+this.record[this.record.length-1] + '<br>');
            this.scrollToBottom();
        };
        this.mousedown = function (e) {
            this.recordWait();
            this.record.push("Framework.Replay.mouseDown("+e.x+","+e.y+");");  // 2017.02.21 added
            this.addDivString('&nbsp;&nbsp;&nbsp;&nbsp;'+this.record[this.record.length-1] + '<br>');
            this.scrollToBottom();
        };
        this.mouseup = function (e) {
            this.recordWait();
            this.record.push("Framework.Replay.mouseUp("+e.x+","+e.y+");");    // 2017.02.21 added
            this.addDivString('&nbsp;&nbsp;&nbsp;&nbsp;'+this.record[this.record.length-1] + '<br>');
            this.scrollToBottom();
        };
