var MyGame4 = Framework.Class(Framework.Level , {
    load: function(){
        ...
        ////////Load通道1/////////
        this.gameTunnel[0]=new GameGTunnel(3); //參數為通道起始,終止位置
        this.gameTunnel[0].load(this.setX,this.setY,0);
        this.rootScene.attach(this.gameTunnel[0]);

        ////////Load通道2/////////
        this.gameTunnel[1]=new GameGTunnel(5); //參數為通道起始,終止位置
        this.gameTunnel[1].load(Framework.Game.getCanvasWidth()-240,800,0);
        this.rootScene.attach(this.gameTunnel[1]);


        ////////移動型通道1/////////
        this.gameTunnel[2]=new MovingTunnel();
        this.gameTunnel[2].get(590,340);
        this.gameTunnel[2].load(465,200,1);
        this.rootScene.attach(this.gameTunnel[2].blockPic);


        ////////移動型通道2/////////
        this.gameTunnel[3]=new MovingTunnel();
        this.gameTunnel[3].get(840,590);
        this.gameTunnel[3].load(715,200,-1);
        this.rootScene.attach(this.gameTunnel[3].blockPic);

        ////////移動型通道3/////////
        this.gameTunnel[4]=new MovingPTunnel();
        this.gameTunnel[4].get(230,516);
        this.gameTunnel[4].load(810,300,-2);
        this.rootScene.attach(this.gameTunnel[4].blockPic);

        ////////移動型通道4/////////
        this.gameTunnel[5]=new MovingTunnel();
        this.gameTunnel[5].get(840,590);
        this.gameTunnel[5].load(715,545,1);
        this.rootScene.attach(this.gameTunnel[5].blockPic);

        ////////移動型通道5/////////
        this.gameTunnel[6]=new MovingPTunnel();
        this.gameTunnel[6].get(575,830);
        this.gameTunnel[6].load(620,676,-1);
        this.rootScene.attach(this.gameTunnel[6].blockPic);

        ////////移動型通道6/////////
        this.gameTunnel[7]=new MovingTunnel();
        this.gameTunnel[7].get(650,1334);
        this.gameTunnel[7].load(992,800,-2);
        this.rootScene.attach(this.gameTunnel[7].blockPic);


        ////////Load終點/////////
        this.goalpic = new GoalSign();
        this.goalpic.load(Framework.Game.getCanvasWidth()-52,800);
        this.rootScene.attach(this.goalpic.goalPic);

        ////////Load滑鼠圖形隨行/////////
        this.mousepic = new MousePicMove();
        this.mousepic.load(this.setX,this.setY);    //為了確認換關先讓滑鼠的X座標往右50pixel
    ...
    update: function() {
        ...
        if(!this.goalpic.isClear && !this.isEnd){
            for(i=2;i<8;i++){
                this.gameTunnel[i].update();     //可移動通道
            }
        }
        
        

        this.covered(this.mousepic);    //將所有固定型通道統合並確認是否在通道內
