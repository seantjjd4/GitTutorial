var MyGame3 = Framework.Class(Framework.Level , {
	load: function(){
        ...
        ////////Load通道2/////////
        this.gameTunnel[1]=new GameGTunnel(18); //參數為通道起始,終止位置
        this.gameTunnel[1].load(600,this.setY,0);
        this.rootScene.attach(this.gameTunnel[1]);


        ////////移動型通道/////////
        this.gameTunnel[2]=new MovingTunnel();
        this.gameTunnel[2].get(590,320);
        this.gameTunnel[2].load(400,200,1);
        this.rootScene.attach(this.gameTunnel[2].blockPic);


        ////////Load終點/////////
        this.goalpic = new GoalSign();
        this.goalpic.load(Framework.Game.getCanvasWidth()-52,200);
    ...
    update: function() {
        ...
        this.gameTunnel[2].update();     //可移動通道
